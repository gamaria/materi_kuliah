              ...
              <div class="box">
                ...
                <div class="box-body">
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                  <?php 
                    $tampil = mysql_query("SELECT * FROM rb_users where level!='superuser' and level!='petugas'  ORDER BY id_user DESC");
                    $no = 1;
    ...
    echo "<div class='col-md-12'>
              <div class='box box-info'>
                <div class='box-header with-border'>
                  <h3 class='box-title'>Edit Data Login Kepala Bidang</h3>
                </div>
              <div class='box-body'>
