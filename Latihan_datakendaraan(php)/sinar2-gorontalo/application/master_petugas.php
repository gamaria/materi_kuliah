            ...
            <div class="col-xs-12">  
              <div class="box">
                <div class="box-header">
                  ...
                  <a class='pull-right btn btn-primary btn-sm' href='index.php?view=petugas&act=tambah'>Tambahkan Data Petugas</a>
                </div><!-- /.box-header -->
                <div class="box-body">
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                  <?php 
                    $tampil = mysql_query("SELECT * FROM rb_users where level='petugas' ORDER BY id_user DESC");
                    $no = 1;
                    ...
                    echo "<tr><td>$no</td>
                              ...
                              <td><center>
                                <a class='btn btn-success btn-xs' title='Edit Data' href='?view=petugas&act=edit&id=$r[id_user]'><span class='glyphicon glyphicon-edit'></span></a>
                                <a class='btn btn-danger btn-xs' title='Delete Data' href='?view=petugas&hapus=$r[id_user]'><span class='glyphicon glyphicon-remove'></span></a>
                              </center></td>";
                            echo "</tr>";
                      $no++;
                      }
...
<?php 
    ...
    if (isset($_POST[tambah])){
      $data = md5($_POST[b]);
      $passs=hash("sha512",$data);
      mysql_query("INSERT INTO rb_users VALUES('','$_POST[a]','$passs','$_POST[c]','$_POST[d]','$_POST[e]','$_POST[f]','petugas','Y')");
      echo "<script>document.location='index.php?view=petugas';</script>";
    }
